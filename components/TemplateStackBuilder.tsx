...
interface TemplateStackBuilderProps {
  ...
  activeView: 'composition' | 'variables';
  onViewChange: (view: 'composition' | 'variables') => void;
...
const TemplateStackBuilder: React.FC<TemplateStackBuilderProps> = ({
  ...
  return (
    <div className="bg-white border-b border-gray-200 shadow-sm relative z-20 flex flex-col shrink-0">
      ...
      <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/30 shrink-0">
        <div className="flex items-center space-x-6">
            ...
            <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
                <button
                    onClick={() => onViewChange('composition')}
                    className={`px-3 py-1 text-xs font-medium rounded-md transition-all ${activeView === 'composition' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                >
                ...
                <button
                    ...
                    className={`px-3 py-1 text-xs font-medium rounded-md transition-all ${activeView === 'variables' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                >
      ...
      {/* 2. Visual Builder Area (Only shown in Composition mode) */}
